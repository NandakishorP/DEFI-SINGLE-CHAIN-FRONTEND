...
import { DepositWithdrawal, getUserWithdrawalHistory, getUserWithdrawals } from '@/lib/graphClient';
import { formatTokenAmount, getTokenName } from '@/lib/tokenHelpers';
...
export default function WithdrawHistory() {
    ...
    const [history, setHistory] = useState<DepositWithdrawal[]>([])
    ...
    useEffect(() => {
        async function fetchHistory(initialLoad = false) {
            ...
            try {
                const withdrawals = await getUserWithdrawalHistory(address);
        ...
        // Poll every 5 seconds without toggling loading state
        ...
        return (
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 mt-10">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                    Withdrawal <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">History</span>
                </h2>
                <p className="text-gray-500 text-center py-8">
                    Connect your wallet to view your withdrawal history
                </p>
            </div>
        );
    }
            ...
            <table className="w-full text-left border-collapse">
                ...
                <tbody>
                    {history.map((h) => {
                        ...
                        const formattedAmount = formatTokenAmount(h.amount, h.tokenAddress);
